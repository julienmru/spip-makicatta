 ...
 * @param string $type
 *     Type de formulaire permettant au squelette de le styler
 * @param string $label
 *     Descriptif du champ (chaine de traduction)
 * @return array Environnement du formulaire
 **/
function formulaires_recherche_ecrire_charger_dist($action = '', $class = '', $type = '', $label = '') {
