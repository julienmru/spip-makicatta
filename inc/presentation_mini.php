 ...
 * @return string Code HTML
 */
function fin_gauche() { return "</div>"; }
...
function debut_droite() {
	...
	. "</div>"
	. "\n<div class='col-md-8 col-lg-9 order-first' id='contenu' role='contentinfo'>";
}
...
function fin_page() {
	...
	$t = '</div></div></section></div><footer class="main-footer text-right">'
		. recuperer_fond('prive/squelettes/inclure/pied')
		. "</footer></div>" // cf. div#page et div.largeur ouvertes dans conmmencer_page()
