...
function debut_onglet($classe = "barre_onglet") { return "<ul class='nav nav-pills ml-auto p-2 $classe'>\n"; }
...
function onglet($texte, $lien, $onglet_ref, $onglet, $icone = "") {
	return "<li><a class='nav-link".(($onglet == $onglet_ref) ? ' active' : '')."' href='$lien'>".makicatta_icone($icone)." $texte</li>";
}
